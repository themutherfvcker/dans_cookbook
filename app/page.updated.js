...
const HomeGenScript = dynamic(() => import("./components/HomeGenScript"), { ssr: false })
...
export default function HomePage() {
  useEffect(() => {
    ...
    // --- Wire the generator button to your APIs ---
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="lg:text-center">
      <h2 className="text-base text-yellow-600 font-semibold tracking-wide uppercase">AI Generator</h2>
    ...
    <div className="mt-8">
      <div className="flex gap-2 justify-center">
        <button id="tab-t2i" className="px-4 py-2 rounded-md bg-yellow-600 text-white hover:bg-yellow-700 focus:outline-none">
          Text to Image
        </button>
        <button id="tab-i2i" className="px-4 py-2 rounded-md bg-white border text-gray-700 hover:bg-gray-50 focus:outline-none">
          Image to Image
        </button>
      </div>
      ...
      <div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            <div id="panel-t2i">
              <h3 className="text-lg leading-6 font-medium text-gray-900">Text → Image</h3>
              <p className="mt-1 text-sm text-gray-500">Type a prompt and generate an image with Gemini 2.5 Flash Image Preview.</p>
              <div className="mt-5">
                <label htmlFor="t2i-prompt" className="block text-sm font-medium text-gray-700">Prompt</label>
                <textarea id="t2i-prompt" rows={4} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500" placeholder="a cinematic banana astronaut on the moon, 35mm film look"></textarea>
              </div>
              <div className="mt-4 flex items-center gap-3">
                <button id="t2i-generate" className="inline-flex items-center px-4 py-2 rounded-md bg-yellow-600 text-white hover:bg-yellow-700 disabled:opacity-50">Generate (−1 credit)</button>
                <a href="/pricing" className="text-sm text-yellow-700 underline">Buy credits</a>
              </div>
            </div>

            <div id="panel-i2i" className="hidden">
              <h3 className="text-lg leading-6 font-medium text-gray-900">Image → Image</h3>
              <p className="mt-1 text-sm text-gray-500">Upload a reference image, then describe the edit.</p>

              <div className="mt-4">
                <label className="block text-sm font-medium text-gray-700">Reference Image</label>
                <input id="i2i-file" type="file" accept="image/*" className="mt-1 block w-full text-sm text-gray-700" />
                <p className="mt-1 text-xs text-gray-500">PNG or JPG up to ~8MB</p>
              </div>

              <div className="mt-4">
                <label htmlFor="i2i-prompt" className="block text-sm font-medium text-gray-700">Edit Prompt</label>
                <textarea id="i2i-prompt" rows={3} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-yellow-500 focus:ring-yellow-500" placeholder="Add chocolate drizzle; write “Made Fresh Daily” across the top."></textarea>
              </div>

              <div className="mt-4 flex items-center gap-3">
                <button id="i2i-generate" className="inline-flex items-center px-4 py-2 rounded-md bg-yellow-600 text-white hover:bg-yellow-700 disabled:opacity-50">Generate (−1 credit)</button>
                <a href="/pricing" className="text-sm text-yellow-700 underline">Buy credits</a>
              </div>
            </div>

            <div id="nb-error" className="hidden mt-4 rounded-md bg-red-50 p-3 text-sm text-red-700"></div>
          </div>
        </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <p className="mt-1 text-sm text-gray-500">Your generated image will appear below.</p>
            <div className="mt-5 border-t border-gray-200"></div>

            <div className="mt-6 flex flex-col items-center justify-center">
              <img id="nb-result" alt="Result" className="max-w-full rounded-lg shadow hidden" />
              <a id="nb-download" className="hidden mt-4 inline-flex items-center px-3 py-2 rounded-md bg-gray-900 text-white hover:bg-black" download="result.png">Download PNG</a>
            </div>
          </div>
        </div>
      </div>
  ...
  {/* Wire up events with a client component */}
  <HomeGenScript />
</section>
